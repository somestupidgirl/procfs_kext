...
struct sysent * find_sysent_table()
{
    ...
    if (!nosys || !exit || !fork) {
        printf("moonAgirl[kernel_find_symbol] failed.\n");
        return NULL;
    }
    printf("moonAgirl[kernel_find_symbol] success.\n");
    ...
    if(!section){
        printf("moonAgirl[macho_find_section] failed.\n");
        return NULL;
    }
    printf("moonAgirl[macho_find_section] success.\n");
